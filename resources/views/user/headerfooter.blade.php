...
<body class="bg-info">
  ...
  <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
        ...
        <a href="/viewinsurancepolicies" class="nav-item nav-link">View Insurance Policies</a>
  ...
  <!-- Footer Start -->
  <div class="container-fluid bg-dark footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s" style="visibility: hidden; animation-delay: 0.1s; animation-name: none;">
    <div class="container py-5">
      <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <p>
            <i class="fa fa-map-marker-alt me-3"></i>115 Street, Ernakulam, India
          </p>
          <p><i class="fa fa-phone-alt me-3"></i>+91 88485 46944</p>
          <p><i class="fa fa-envelope me-3"></i>insure@example.com</p>
        </div>
        <div class="col-lg-3 col-md-6">
